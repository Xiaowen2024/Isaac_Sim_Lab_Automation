...
CONTACT_ASSET_DIR = BENCHMARK_ROOT / "contact_assets_claude_v3"
...
def build_refined_tube(*, force: bool) -> Path:
    ...
    _add_collision_cylinder(
        ...
        # v3 minimal change: shrink collar from 25mm (7.25mm beyond visible 17.75mm
        # cap radius) to 19mm (1.25mm beyond visible). Keeps the mechanical capture
        # the contact_shelf hooks under, but cuts the rendered "fingers floating
        # off tube" gap from ~7mm to ~1mm. Everything else identical to baseline.
        radius=19.0,
