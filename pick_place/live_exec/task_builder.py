...
try:
    ...
    class SolidPrimitive:  # type: ignore[override]
        BOX = 1
        SPHERE = 2
        CYLINDER = 3
        CONE = 4
...
GRASP_TOOL_CLEARANCE_M = -0.003
PHYSICAL_VERIFY_LIFT_HEIGHT_M = 0.03
BREAKOUT_LIFT_HEIGHT_M = 0.012
...
def build_leg_plan(
    *,
    ...
    breakout_tool_w = _offset_world_z(grasp_tool_w, min(verify_lift_height_m, BREAKOUT_LIFT_HEIGHT_M))
    ...
    return LiveLegPlan(
        ...
        breakout=TaskPose.from_pose_wxyz(_pose_in_robot_frame(ee_body_pose_from_tool_pose(breakout_tool_w), robot_pose_w)),
