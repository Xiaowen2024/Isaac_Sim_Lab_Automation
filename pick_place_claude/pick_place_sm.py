...
parser.add_argument("--asset_profile", type=str, default="contact_refined", choices=["imported", "contact_refined"])
...
from wetlab_benchmark.pick_place_claude.task_policy import Phase, PickPlaceTaskPolicy
