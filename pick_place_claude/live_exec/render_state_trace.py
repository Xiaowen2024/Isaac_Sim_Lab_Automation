...
from wetlab_benchmark.pick_place_claude.live_exec.protocol import camera_from_preset
from wetlab_benchmark.pick_place_claude.live_exec.task_builder import LiveTask, PoseWxyz, build_live_task
