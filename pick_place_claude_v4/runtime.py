...
CONTACT_ASSET_DIR = Path(__file__).resolve().parents[1] / "contact_assets_claude_v4"
    ...
    if asset_profile == ASSET_PROFILE_CONTACT_REFINED:
        ...
        if missing_assets:
            raise FileNotFoundError(
                ...
                "wetlab_benchmark/pick_place_claude_v4/live_exec/build_contact_refined_assets.py --force` first. "
